...
<?php   include 'ini/mysql.php' ?>
  ...
  */
    ...
    $stu_num_sql="select * from stu_infor where class_bh = '$class_bh'";
    ...
    $stu_page_sql="select * from stu_infor where class_bh = '$class_bh' limit $start_num ,$perpage";
...
<div class="centercontent">      
              <div class="contenttitle2">
               ...
               <div class="tableoptions">
                ...
                <!--     <tfoot>
                    ...
                    <?php while($stu_page_info=mysql_fetch_array($stu_page_excu)){ 
                        $stu_xh_tag=$stu_page_info['stu_xh'];
                        ?>
                        <tr class="gradeX">
                          <td align="center"><span class="center">
                            ...
                            <td style=" text-align: center;"><?php echo $stu_xh_tag; ?></td>
                            <td style=" text-align: center;"><a href="stu_score.php?stu_xh=<?php echo $stu_xh_tag;?> "><?php echo $stu_page_info['stu_name']; ?></a></td>
                ...
                <a href="class_page.php?class_bh=<?php echo $class_bh; ?>
               ...
               <a href="class_page.php?class_bh=<?php echo $class_bh; ?>
                &class_name=<?php echo $class_name; ?>
                &curr_page=<?php echo $next_page;?>">
                <span class="paginate_button">下一页</span>
                </a>
                <a href="class_page.php?class_bh=<?php echo $class_bh; ?>
                &class_name=<?php echo $class_name; ?>
                &curr_page=<?php echo $pages;?>">
